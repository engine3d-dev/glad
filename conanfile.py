...
class GladRecipe(ConanFile):
    ...
    license = "Apache-2.0"
    homepage = "https://github.com/engine3d-dev/glad"
    ...
    exports_sources = "CMakeLists.txt", "src/CMakeLists.txt", "include/glad/*.h", "src/glad.c"
    ...
    def package(self):
        ...
        copy(self, pattern="*.h", src=os.path.join(self.source_folder, "include/glad"), dst=os.path.join(self.package_folder, "glad"))
        copy(self, pattern="*.h", src=os.path.join(self.source_folder, "include/KHR"), dst=os.path.join(self.package_folder, "glad/KHR"))
        copy(self, pattern="*.c", src=os.path.join(self.source_folder, "."), dst=os.path.join(self.package_folder, "glad"))
    ...
    def package_info(self):
        self.cpp_info.set_property("cmake_target_name", "glad::glad")
